...
int cluster(float points[N_OBJ][N_ATTR],      /* [N_OBJ][N_ATTR] */
            float threshold       /* in:   */

) ;

void **kmeans_clustering(float points[N_OBJ][N_ATTR],    /* in: [N_OBJ][N_ATTR] */
                         float threshold,
                         int membership[N_OBJ]) /* out: [N_OBJ] */
;

int main(int argc, char *argv[]) {
  float attributes[N_OBJ][N_ATTR];
  int i, j;
  ...
  cluster(attributes,           /* [N_OBJ][N_ATTR] */
          threshold
  );
